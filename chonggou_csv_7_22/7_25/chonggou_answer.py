...
def cluster_excle(path,savepath):
    ...
    answer_df1 = pd.DataFrame(columns=("uid","d","x","y","z"))
...
#读取文件
path_answer = r"E:\fuxing_idea\chonggou_csv_7_22\7_25\file\syshbzh.csv"
savepath = r"E:\fuxing_idea\chonggou_csv_7_22\7_25\file\syshbzh_chg.csv"
