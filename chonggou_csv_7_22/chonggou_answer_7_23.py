...
savepath = r"E:\fuxing_idea\chonggou_csv_7_22\7-23\answer1_answer_2_3.csv"
path1 = r"E:\fuxing_idea\chonggou_csv_7_22\7-23\answer1.csv"
...
answer2_df = read_csv_file(path2)
# stu_df = read_csv_file(path)
# print(answer_df.shape[1])
uid1 = answer1_df["序列编号"]
uid2 = answer2_df["序列编号"]
# uid3 = list(stu_df["seriesInstanceUID"])
bingzao1  = answer1_df["病灶"]
bingzao2  = answer2_df["病灶"]
yxgj1 = answer1_df["影像工具"]
yxgj2 = answer2_df["影像工具"]
yxjg1 = answer1_df["影像结果"]
yxjg2 = answer2_df["影像结果"]
#
# print(uid3)
